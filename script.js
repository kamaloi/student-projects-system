document.addEventListener('DOMContentLoaded', () => {
    ...
    const WEB_APP_URL = 'https://script.google.com/macros/s/AKfycby8SxulfYf7gOikb4zaOeZY2Ub2JVYy6P7iIR9elmhfqRw5OfLit8jJBt7rKmM11jJ-/exec'; 
    ...
    async function sendDataToGoogleSheet() {
        ...
        // 2. التحقق من أن جميع الحقول المطلوبة ليست فارغة
        if (student1 === '' || student2 === '' || projectName === '') {
    ...
    function displayProjects(projects) {
        ...
        const headers = ['اسم الطالب الأول', 'اسم الطالب الثاني', 'اسم المشروع'];
